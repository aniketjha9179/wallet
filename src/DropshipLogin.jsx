  ...
  return (
    <div className="min-h-screen w-full bg-white p-2 py-4">
      <div className="min-h-screen flex flex-col justify-center items-center  ">
        ...
        <div className="w-full bg-white p-3  rounded-[28px] shadow-[0_10px_40px_rgba(0,0,0,0.05)]" style={{maxWidth: '400px'}}>
          ...
          <div className="space-y-3 text-left">
            ...
            <button 
              type="submit" 
              className="w-full bg-[#1d1d1e] border-2 border-[#fff3] bg-gradient-to-b from-[#ffffff26] to-[#fff0]  text-white py-[10px] rounded-[10.5px]   transition text-[15px] font-semibold shadow-[0_4px_6px_-1px_rgba(0,0,0,0.3)]"
